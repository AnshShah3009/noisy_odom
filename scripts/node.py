...
def callback(data):
    ...
    pub = rospy.Publisher("/corrupted_odom", Odometry, queue_size=10)
    odom_corrupted = Odometry()
    odom_corrupted.child_frame_id = "base_link"
    ...
    odom_corrupted.header.frame_id = new_odom_frame
